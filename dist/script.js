...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.dropdown = function () {
  for (let i = 0; i < this.length; i++) {
    const idButton = Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).getAttr('id');
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(() => {
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(`[data-toggle-id="${idButton}"]`).fadeToggle(300);
    });
  }
};
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function () {
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    console.log(Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).getAttr('[data-target]'));
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(modal).addAttr('id', Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).getAttr('data-target').slice(1));

    //btns= {num, settings: [[text, classNames=[], close, cb]]}
    const buttons = [];
    for (let j = 0; j < btns.count; j++) {
      ...
      if (btns.settings[j][2]) {
        Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(btn).addAttr('data-close', 'true');
      }
...
/* Здесь мы импортируем функцию $ и обогащаем её функционалом и потом экспортируем */
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.addAttr = function (attrName, value) {
  for (let i = 0; i < this.length; i++) {
...
Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])().get('https://jsonplaceholder.typicode.com/todos/1').then(res => console.log(res));
